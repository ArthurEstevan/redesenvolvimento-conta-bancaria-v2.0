...
public interface Armazenar {
    ...
    static void inicializarFuncionarios() {
        ...
        funcionarios.put("001", new Funcionario("Admin", (byte) 27, "122.869.252-16", "48.590.932-7", dataCliente001, "Masculino", "Alana Giovanna", "Ryan Mário Leonardo Assis", "79096-149", "Rua Afluente", "767", "Loteamento Rancho Alegre II", "Campo Grande", "MS", "(67) 99286-1494", "1213026-5", new ArrayList<>(List.of("ótimo banco!")), cadastro, "001"));
        funcionarios.put("002", new Funcionario("Dono", (byte) 62, "360.582.916-31", "47.902.576-9", dataCliente002, "Masculino", "Luana Sebastiana", "Luís Yago da Silva", "88085-157", "Rua Joaquim Carneiro", "296", "Abraão", "Florianópolis", "SC", "(48) 98653-9187", "paulo-dasilva83@bb.com.br", new ArrayList<>(List.of("ótimo banco!")), cadastro, "002"));
        funcionarios.put("003", new Funcionario("DevJunior", (byte) 37, "890.736.811-20", "31.175.152-0", dataCliente003, "Feminino", "Emily Benedita Adriana", "Nicolas Bento Almada", "21371-560", "Rua Narciso", "744", "Colégio", "Rio de Janeiro", "RJ", "(21) 99151-7441", "louise.amanda.almada@sicredi.com.br", new ArrayList<>(List.of("ótimo banco!")), cadastro, "003"));
        funcionarios.put("004", new Funcionario("DevPleno", (byte) 79, "416.662.360-55", "48.285.899-0", dataCliente004, "Feminino", "Antonella Liz", "Noah Guilherme Heitor Jesus", "58100-466", "2ª Travessa Castelo Branco", "457", "Santa Catarina", "Cabedelo", "PB", "(83) 98498-9657", "stellaalessandrajesus@hotmail.co.jp", new ArrayList<>(List.of("ótimo banco!")), cadastro, "004"));
        funcionarios.put("005", new Funcionario("DevSenior", (byte) 45, "554.513.961-32", "44.680.748-5", dataCliente005, "Feminino", "Gabrielly Yasmin Sarah", "Kevin Pietro Sebastião da Luz", "71070-506", "Rua 6", "257", "Guará II", "Brasília", "DF", "(61) 99986-7689", "lorena_daluz@biconsult.com.br", new ArrayList<>(List.of("ótimo banco!")), cadastro, "005"));
    }
}
